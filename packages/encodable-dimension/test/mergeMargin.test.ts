...
describe('mergeMargin(margin1, margin2, mode?)', () => {
  ...
  describe('mode', () => {
    it('if mode=max, returns the larger margin for each side', () => {
      expect(
        mergeMargin(
          {
            top: 1,
    ...
    it('if mode=min, returns the smaller margin for each side', () => {
      expect(
        mergeMargin(
          {
            top: 1,
  ...
  it('if there are undefined, NaN or null, use another value', () => {
    expect(
      mergeMargin(
        {
          top: 10,
